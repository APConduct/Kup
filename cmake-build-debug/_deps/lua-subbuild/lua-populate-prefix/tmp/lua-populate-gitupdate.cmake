...
execute_process(
  COMMAND "C:/Users/ajost1/AppData/Local/Programs/Git/cmd/git.exe" --git-dir=.git show-ref "5.4.4"
  WORKING_DIRECTORY "C:/Users/ajost1/CLionProjects/Kup/cmake-build-debug/_deps/lua-src"
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/tags/")
  ...
  get_hash_for_ref("5.4.4" tag_sha error_msg)
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/heads/")
  ...
  set(checkout_name "origin/5.4.4")
  ...
  elseif(tag_sha STREQUAL "")
    ...
    if(NOT can_fetch)
      message(FATAL_ERROR
        "Requested git ref \"5.4.4\" is not present locally, and not "
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: 'C:/Users/ajost1/CLionProjects/Kup/cmake-build-debug/_deps/lua-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: 'C:/Users/ajost1/CLionProjects/Kup/cmake-build-debug/_deps/lua-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
